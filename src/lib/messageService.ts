...
function menteeToParticipant(m: any): Participant {
  return {
    ...
    primary_capability: m.primary_capability || m.capabilities_wanted || null,
    secondary_capability: m.secondary_capability || m.role_specific_area || null,
    bio: m.bio || null,
...
function mentorToParticipant(m: any): Participant {
  return {
    ...
    first_name: m.first_name || m.full_name?.split(' ')[0] || '',
    slack_user_id: m.slack_user_id || null,
    primary_capability: m.primary_capability || m.capabilities_offered || null,
    ...
    hard_earned_lesson: m.hard_earned_lesson || m.meaningful_impact || null,
